...
| Stage 10.1 | Manual validation fixes | Repair private dictionary GUI/dispatcher flow, add safe dictionary status to GUI and reports, and audit remaining loaded dictionary terms. | Current | Still literal and case-sensitive; no OCR, AI, batch processing, database, replacement map, or output-folder workflow. |
